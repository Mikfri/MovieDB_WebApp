import { useFetchHighestRatedMoviesQuery } from "../store/apis/moviesApi"; // routing til map kan drille!
...
function HighestRatedMoviesList() {                                      //Bemærk Query-function kaldes automatisk når komponenten bliver displayed
  ...
  //Step 6 fejl!                                                       //Bemærk Mutation-function returnere et array med en function, som kan kaldes når data skal ændres
